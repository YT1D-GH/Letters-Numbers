...
public class NBlockOnBlockRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (((findEntityInWorldRange(world, Player.class, x, y, z, 4)) instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.LIME_DYE) {
			world.setBlock(BlockPos.containing(x, y, z), LettersAndNumbersModBlocks.N_BLOCK_GREEN.get().defaultBlockState(), 3);
			...
			world.setBlock(BlockPos.containing(x, y, z), LettersAndNumbersModBlocks.N_BLOCK_YELLOW.get().defaultBlockState(), 3);
			if ((findEntityInWorldRange(world, Player.class, x, y, z, 4)) instanceof Player _player) {
