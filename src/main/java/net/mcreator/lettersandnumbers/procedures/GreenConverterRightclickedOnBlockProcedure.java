...
public class GreenConverterRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == LettersAndNumbersModBlocks.A_BLOCK.get()) {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.A_BLOCK_GREEN.get().defaultBlockState();
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.B_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.C_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.D_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.E_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.FBLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.G_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.H_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.I_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.J_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.K_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.L_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.M_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.N_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.O_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.P_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.Q_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.R_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.S_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.T_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.U_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.V_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.W_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.X_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.Y_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = LettersAndNumbersModBlocks.Z_BLOCK_GREEN.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
				for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
					Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
					if (_property != null && _bs.getValue(_property) != null)
			...
			if (world instanceof ServerLevel _level)
				_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
						"tellraw @p [\"\",{\"text\":\"Please point me at a \"},{\"text\":\"white\",\"color\":\"white\"},{\"text\":\" letter block to turn it \"},{\"text\":\"green\",\"color\":\"green\"},{\"text\":\", or if you want it to be \"},{\"text\":\"yellow\",\"color\":\"yellow\"},{\"text\":\" right click the \"},{\"text\":\"white\",\"color\":\"white\"},{\"text\":\" letter block with a \"},{\"text\":\"yellow converter\",\"color\":\"yellow\"}]");
		}
	}
}