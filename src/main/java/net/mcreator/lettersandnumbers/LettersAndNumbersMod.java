package net.mcreator.lettersandnumbers;
...
import net.mcreator.lettersandnumbers.init.LettersAndNumbersModTabs;
...
@Mod("letters_and_numbers")
public class LettersAndNumbersMod {
	public static final Logger LOGGER = LogManager.getLogger(LettersAndNumbersMod.class);
	public static final String MODID = "letters_and_numbers";

	public LettersAndNumbersMod(FMLJavaModLoadingContext context) {
		...
		LettersAndNumbersModTabs.REGISTRY.register(bus);
